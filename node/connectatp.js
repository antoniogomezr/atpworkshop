...
oracledb.getConnection({ user: dbConfig.dbuser,password: dbConfig.dbpassword, connectString: dbConfig.connectString
},
...
user = result.rows[0][0]; console.log(`Check to see if your database
connection worked at	http://localhost:3050/`); error = null; connection.close(function(err) {
if (err) {
console.log(err);
}
});
